      ...
      <div className="relative z-10 h-full px-4 md:px-8 overflow-y-auto [scrollbar-gutter:stable]">
        ...
        <div className="min-h-full flex items-center justify-center py-5 max-h-[885px]:py-6 max-h-[700px]:py-4">
          <div className="w-full max-w-[845px] pb-24 max-h-[885px]:pb-28">
            ...
            {/* Contact Us Card */}
            <motion.div
              className="relative z-[2] w-full max-w-[845px] rounded-[20px] border border-white/60 bg-[radial-gradient(66.79%_318.35%_at_34.13%_-210.76%,rgba(185,176,155,0.20)_0%,rgba(240,240,240,0.20)_100%)] shadow-[7px_9px_14.4px_0px_rgba(0,0,0,0.28)] backdrop-blur-[1.44px] px-[18px] py-[18px] md:px-[20px] md:py-[42px] max-h-[885px]:py-[18px] mb-6 xl:mb-5 max-h-[885px]:mb-4"
              initial={motionCommon.initial}
              animate={motionCommon.animate}
