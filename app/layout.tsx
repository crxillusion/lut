...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      >
        <div id="awwwards" style={{ position: 'fixed', zIndex: 999, transform: 'translateY(-50%)', top: '50%', right: 0 }}>
          <a href="https://www.awwwards.com/sites/lut-studios" target="_blank" rel="noopener noreferrer">
